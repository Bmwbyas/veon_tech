...
export const workhourData=[
    {day:'Понедельник',time:'9:00-17:00',data:'ПН'},
    {day:'Вторник',time:'9:00-17:00',data:'ВТ'},
    {day:'Среда',time:'9:00-17:00',data:'СР'},
    {day:'Четверг',time:'9:00-17:00',data:'ЧТ'},
    {day:'Пятница',time:'9:00-17:00',data:'ПТ'},
    {day:'Суббота',time:'выходной',data:'СБ'},
    {day:'Воскресенье',time:'выходной',data:'ВС'},
]
