            ...
            <div className={s.container}>
                <div className={s.wrapper}>
                    <div className={s.desc}>
                        ...
                        <p className={s.p}>Команда профессиональных специалистов VEON-TECH предоставляет широкий спектр
                            услуг в области
                            ...
                            дизайн.</p>
                        <p className={s.p}>Digital агентство VEON-TECH предлагает комплексную стратегию в формате
